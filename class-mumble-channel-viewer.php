 ...
 *
 * @version 1.01
 * changed a bit for Drupal and added recording + priorityspeaker > ClusterFCK <robin@h-space.be>
 */
  ...
  protected static function renderJson( $jsonUri ) {
    $httpOptions = array(
      'http' => array(
        'method'    => 'GET',
        'timeout'    => 10.0,
        'user_agent'  => 'Drupal Mumble Channel Viewer 1.0'
      )
    );
 ...
 *
 * @since 1.01
 * added recording + priorityspeaker with an isset, cause almost ALL Json outputs do NOT support these 2 as of now. (1-1-12)
 */
